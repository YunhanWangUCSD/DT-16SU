...
//        dag.addOperator("ConsoleOutput", consoleOutputOperator);
        ...
        // configure operators
        reader.setDirectory("/tmp/yunhan/fileToJdbc/input-dir");
        ...
        jdbcOutputOperator.setTablename("test_file_to_jdbc_table_1");
...
//        dag.addStream("test", parser.out, consoleOutputOperator.input);
        dag.addStream("POJO's", parser.out, jdbcOutputOperator.input).setLocality(DAG.Locality.CONTAINER_LOCAL);
    }
